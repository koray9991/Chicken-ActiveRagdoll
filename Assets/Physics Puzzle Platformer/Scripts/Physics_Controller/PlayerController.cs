...
public class PlayerController : MonoBehaviour
{
    ...
    void PlayerInput()
    {
        transform.position += new Vector3(js.Horizontal * moveSpeed, 0, js.Vertical * moveSpeed);
        if (js.Horizontal != 0 || js.Vertical != 0)
        {
           ragdollPlayer.transform.rotation = Quaternion.LookRotation(new Vector3(-js.Horizontal * moveSpeed, 0, js.Vertical * moveSpeed));
  ...
  //  ---Player Rotation
    void PlayerRotation()
    {
        ...
        physicsJoint.targetRotation = transform.rotation;
